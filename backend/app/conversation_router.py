...
from .questionnaire import Question, parse_answer, parse_boolean, parse_choice, parse_numeric
...
def has_clear_answer(question: Question, answer_text: str, answers: dict[str, Any] | None = None) -> bool:
    ...
    if question.input_type == "integer":
        return parse_numeric(cleaned, integer_only=True) is not None
    if question.input_type == "number":
        return parse_numeric(cleaned) is not None
