...
const BASE_TRANSLATIONS: Record<'ta' | 'hi', Record<string, string>> = {
  ta: {
    ...
    "I couldn't find that phone number in the demo patient directory. Please enter a registered 10-digit number.": 'டெமோ நோயாளர் பட்டியலில் அந்த தொலைபேசி எண் கிடைக்கவில்லை. தயவுசெய்து பதிவு செய்யப்பட்ட 10 இலக்க எண்ணை உள்ளிடுங்கள்.',
  ...
  hi: {
    ...
    "I couldn't find that phone number in the demo patient directory. Please enter a registered 10-digit number.": 'डेमो मरीज निर्देशिका में वह फोन नंबर नहीं मिला। कृपया पंजीकृत 10 अंकों वाला नंबर दर्ज करें।',
...
const EXTRA_TRANSLATIONS: Record<'te' | 'ml' | 'kn', Record<string, string>> = {
  te: {
    ...
    "I couldn't find that phone number in the demo patient directory. Please enter a registered 10-digit number.": 'డెమో రోగి డైరెక్టరీలో ఆ ఫోన్ నంబర్ కనబడలేదు. దయచేసి నమోదు చేసిన 10 అంకెల నంబర్ ఇవ్వండి.',
  ...
  ml: {
    ...
    "I couldn't find that phone number in the demo patient directory. Please enter a registered 10-digit number.": 'ഡെമോ രോഗി ഡയറക്ടറിയിൽ ആ ഫോൺ നമ്പർ കണ്ടെത്താനായില്ല. രജിസ്റ്റർ ചെയ്ത 10 അക്ക നമ്പർ നൽകുക.',
  ...
  kn: {
    ...
    "I couldn't find that phone number in the demo patient directory. Please enter a registered 10-digit number.": 'ಡೆಮೋ ರೋಗಿ ಡೈರೆಕ್ಟರಿಯಲ್ಲಿ ಆ ಫೋನ್ ಸಂಖ್ಯೆ ಸಿಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ನೋಂದಾಯಿತ 10 ಅಂಕೆಯ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ.',
